...
const Cart = () => {
    const {cart,removeItem,clearCart,SumarTotalFinal} = useContext(CartContext);
 ...
 const handleStock =()=>{
    ...
    return(
        <div className="contenedor">
            ...
            <Form onChangeDatos={onChangeDatos} handleCompra={handleCompra} user={user} email2={email2}/>
         </div>  
          :
